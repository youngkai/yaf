...
{  
    ...
    {
        return $this->_REDIS->setOption(Redis::OPT_SCAN, Redis::SCAN_RETRY);
    }  
    ...
    {  
        return $this->_REDIS->getOption(Redis::OPT_SCAN);
    }  
    ...
    {  
        ...
        if (is_array($set) && !empty($set)) {  
            if ($newset) {  
                $return = $this->_REDIS->sDiffStore($return,$newset, $set);
            } else {  
                $return = $this->_REDIS->sDiff($return, $set);
            }  
        }  
